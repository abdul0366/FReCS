...
Original file is located at
    https://colab.research.google.com/drive/1TFpwxtSx6kEcnA0vDk16Sk8P3hAj8_Ub
"""
...
plt.savefig('/home/aaadfg/fr/fr_fr.png')
plt.show()
...
onnx_file_path = "fr_fr_classifier.onnx"

torch.onnx.export(model.module,  # Use model.module instead of model
                  (dummy_input_ids, dummy_attention_mask),
                  "fr_fr_classifier.onnx",
                  export_params=True,
                  opset_version=11,
