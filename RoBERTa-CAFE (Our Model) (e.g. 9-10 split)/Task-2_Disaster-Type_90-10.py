...
Original file is located at
    https://colab.research.google.com/drive/1JBcIH3qfFZc1cbB4ogbAyCq6x12jsj2Q
"""
...
encoded_dict = {"Bombings": 0, "Collapse": 1, "Crash": 2, "Derailment": 3,
    "Earthquake": 4, "Explosion": 5, "Fire": 6, "Floods": 7,
    "Haze": 8, "Meteorite": 9, "Shootings": 10, "Typhoon": 11,
    "Wildfire": 12}

df_train['event'] = df_train['Disaster_Type'].map(encoded_dict)
df_test['event'] = df_test['Disaster_Type'].map(encoded_dict)
...
torch.save(model.state_dict(), '/home/aaadfg/fr/ds_model_70.pth')
...
plt.savefig('/home/aaadfg/fr/fr_ds.png')
plt.show()