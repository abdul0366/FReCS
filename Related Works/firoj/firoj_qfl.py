...
Original file is located at
    https://colab.research.google.com/drive/1hVx_H5NSb4jlBlYsgy3_pbthbsiGFrXW
"""
...
df_train = pd.read_csv("/home/aaadfg/fr/related_work/firoj/2013_Queensland_Floods_train.csv")
df_test = pd.read_csv("/home/aaadfg/fr/related_work/firoj/2013_Queensland_Floods_test.csv")
...
encoded_dict = {"not_relevant": 0, "relevant": 1}

df_train['event'] = df_train['label'].map(encoded_dict)
df_test['event'] = df_test['label'].map(encoded_dict)
